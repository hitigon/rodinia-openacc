	  ...
	  commandPointer++;
		switch (instruction) {
			...
			case 'k':
			{
				...
				long int records_elem = (long int)rootLoc / sizeof(record);
				long int records_mem = (long int)rootLoc;
				...
				knode *knodes = (knode *)((long int)mem + (long int)rootLoc);
				long int knodes_elem = ((long int)(mem_used) - (long int)rootLoc) / sizeof(knode);
				long int knodes_mem = (long int)(mem_used) - (long int)rootLoc;
				...
				long int *currKnode;
				currKnode = (long int *)malloc(count*sizeof(long int));
				// INPUT: offset CPU initialization
                memset(currKnode, 0, count*sizeof(long int));

				// INPUT: offset CPU allocation
				long int *offset;
				offset = (long int *)malloc(count*sizeof(long int));
				// INPUT: offset CPU initialization
                memset(offset, 0, count*sizeof(long int));
        ...
        fclose(pFile);
			...
			case 'j':
			{
				...
				long int *lastKnode;
				lastKnode = (long int *)malloc(count*sizeof(long int));
				// INPUT: offset CPU initialization
				memset (lastKnode, 0, count*sizeof(long int));

				// INPUT: offset_2 CPU allocation
				long int *offset_2;
				offset_2 = (long int *)malloc(count*sizeof(long int));
				// INPUT: offset CPU initialization
				memset (offset_2, 0, count*sizeof(long int));
